...
const onboardingScreenList = [
    {
        id: '1',
        onboardingImage: require('../../assets/images/saving_money.png'),
        title: 'Start Saving Money',
        description: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Et, congue ut imperdiet sit nulla fringilla in id volutpat..`,
    },
    {
        id: '2',
        onboardingImage: require('../../assets/images/work_portfolio.png'),
        title: 'Boost Your Portfolio',
        description: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Et, congue ut imperdiet sit nulla fringilla in id volutpat.`,
    },
    {
        id: '3',
        onboardingImage: require('../../assets/images/investment_in_stocks.png'),
        ...
        return (
            <View style={styles.skipAndDoneWrapStyle}>
                {activeSlide != 2
                    ?
                    <Text
                        onPress={() => navigation.push('SigninSignup')}
